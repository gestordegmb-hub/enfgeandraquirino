...
const TechnologiesSection = () => {
  return (
    <section id="tecnologias" className="section-padding bg-gradient-premium relative overflow-hidden">
      ...
      <div className="absolute -top-40 -left-40 w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full bg-rose/10 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-40 -right-40 w-[300px] h-[300px] md:w-[500px] md:h-[500px] rounded-full bg-rose-gold/10 blur-3xl pointer-events-none" />
      <div className="max-w-7xl mx-auto relative z-10">
        <ScrollReveal>
          <div className="text-center space-y-4 mb-16 md:mb-24">
            ...
            <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-primary-foreground tracking-tight">Tecnologias utilizadas</h2>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {technologies.map((tech, index) => (
            <ScrollReveal key={tech.title} delay={index * 0.08}>
              <div className="group text-center space-y-5 p-6 sm:p-8 rounded-2xl border border-primary-foreground/15 hover:border-rose-gold/50 bg-primary-foreground/8 hover:bg-primary-foreground/12 backdrop-blur-sm transition-all duration-500 h-full hover:-translate-y-1">
