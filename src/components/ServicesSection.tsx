...
const services: Service[] = [
  {
    ...
    detail: {
      intro: "Consulta de Enfermagem baseada no Processo de Enfermagem, conforme recomendação do COFEN.",
      items: [
        "Levantamento dos fatores de risco para cicatrização e complicações pós-operatórias",
        "Educação em saúde específica para cada tipo de cirurgia",
        "Preparo da área a ser operada com tecnologias como laser e ozonioterapia",
        "Preparo sistêmico do corpo com técnicas que regulam o estresse oxidativo, reduzem toxinas e melhoram a oxigenação dos tecidos",
      ],
    },
  },
  {
    ...
    detail: {
      items: [
        "Terapias no intra e pós-operatório como tapping, laser, ozônio e PRF/I-PRF",
        "Terapias como ILIB e laserpuntura para redução de dor e edema",
        "Disponibilização de equipe treinada para acompanhamento hospitalar e domiciliar",
        "Visitas para auxílio em higiene com técnica adequada",
        "Monitoramento da drenagem e retirada segura de drenos e pontos",
        "Avaliação contínua de intercorrências com emissão de relatório para o médico",
      ],
    },
  },
  {
    ...
    detail: {
      items: [
        "Avaliação profunda dos fatores que interferem na cicatrização",
        "Aplicação do Processo de Enfermagem com raciocínio clínico",
        "Uso das melhores tecnologias conforme a fase da cicatrização",
        "Tecnologias utilizadas: laser, ozônio, PRP, PRF, VAC, cannabis medicinal",
        "Tratamento combinado de forma segura e eficaz",
        "Prescrição adequada de coberturas para acelerar a cicatrização",
      ],
    },
  },
  {
    ...
    detail: {
      items: [
        "Atendimento no conforto da sua casa, reduzindo deslocamentos",
        "Indicado para pacientes acamados ou com dificuldade de locomoção",
        "Aplicação de terapias como ozonioterapia e laser para dor e imunidade",
        "Avaliação de fatores ambientais que influenciam a recuperação",
        "Treinamento de cuidadores para garantir segurança no dia a dia",
      ],
    },
  },
  {
    ...
    detail: {
      items: [
        "Treinamento de equipes hospitalares para cuidados com feridas e pós-operatório",
        "Capacitação de equipes de enfermagem e assistentes",
        "Treinamento para instituições de longa permanência (ILPIs)",
        "Projetos como “Cia da CicatrizAÇÃO”",
        "Consultoria para protocolos de prevenção e tratamento",
        "Consultoria para pacientes e familiares",
        "Mentorias para profissionais que desejam se especializar",
        "Ensino de consulta de enfermagem presencial e online",
      ],
    },
  },
  {
    ...
    detail: {
      items: [
        "Cuidados baseados em protocolos nacionais e internacionais",
      ],
      subgroups: [
        {
      ...
      highlight: "Cuidado completo para uma recuperação mais rápida, segura e eficiente.",
    },
  },
];
